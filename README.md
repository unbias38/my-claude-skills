...
| [interpreting-stock-mood](./interpreting-stock-mood) | 股票溝通師：把「跟寵物溝通」的玄學風格套到股票分析。給股票代號 + 提問，自動抓股價、PTT 提及率、Yahoo 留言、三大法人、Google News（雙來源容錯：yfinance + RSS），用客觀技術指標（MA/RSI/MACD/布林/KD）解讀「股票心情」，產出擬人化獨白 + 情緒推測 + 行動建議 + 多維熱度交叉驗證五區塊，可選產出含 7 張圖的 DOCX。內含台股黑話辨識（航海王、護國神山、正二/反一）、強制「非投資建議」免責、失敗來源透明標註。風格靈感來自 [@ChatGPT3a01](https://github.com/ChatGPT3a01) 的寵物溝通師 |
