...
一個 Claude Code skill —— 從股價、新聞、PTT、Yahoo 留言、三大法人、Google Trends 萃取客觀特徵，結合技術指標（MA / RSI / MACD / 布林 / KD / 量價）解讀「股票心情」，用擬人化獨白搭配寫實技術解讀，產出情緒推測 + 行動建議 + 技術摘要 + 多維熱度交叉驗證五區塊報告，並可一鍵產出含 7 張圖的 DOCX 報告。
